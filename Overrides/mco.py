...
class ModClassOverride(object):
    ...
    def _determine_source_mod(self):
        ...
        # Ignore previous mods coming from processing XCE
        if "MODS" not in src_upper and "WORKSHOP" not in src_upper:
        ...
        print("MCO %s source mod determined as: %s" %
              (self, self.source_mod_name))
